...
export function ShareModal({ isOpen, onClose, formTitle, formSlug, onSlugChange }: ShareModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            {/* Modal */}
            <div className="relative bg-white dark:bg-gray-900 rounded-xl shadow-2xl w-full max-w-md mx-4 animate-scale-in">
                {/* Header */}
                ...
                {/* Footer */}
                <div className="p-4 border-t bg-gray-50 dark:bg-gray-800/50 rounded-b-xl">
